...
const hc_Showtiktok = () => {
  ...
  const showTiktok_info = [
    {
      topic: "Showcase (Tiktok)",
      description:
        "เปิดโลกแห่งความคิดสร้างสรรค์และแรงบันดาลใจผ่านผลงานวิดีโอ TikTok จากเหล่านักศึกษามหาวิทยาลัยศรีปทุม! ที่นี่คือพื้นที่สำหรับการแสดงออกไอเดียใหม่ๆ ที่สะท้อนตัวตน ความสามารถ และทักษะของคนรุ่นใหม่",
    },
  ];
